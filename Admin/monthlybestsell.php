<div class="container">
  ...
  <label class="text-info">Monthly Best Selling Items </label> <br><br>
 ...
 ?>
  ...
  <div class="row">
   <table class="table table-dark table-striped">
    ...
    WHERE o.OrderId=oit.OrderId AND oit.ItemId=i.ItemId AND t.ItemTypeId=i.ItemTypeId AND MONTH(OrderDate)='$m' and YEAR(OrderDate)='$y' GROUP BY oit.ItemId Order By ot DESC LIMIT 10";
